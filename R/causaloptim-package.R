...
#' 
#' @details Run the shiny app by results <- specify_graph(). See detailed instructions in the vignett browseVignettes("causaloptim").
#' @author Michael C Sachs, Arvid Sjölander, Alexandre Balke, Colorado Reed, and Erin Gabriel
