...
#'         \item{R}{A matrix with coefficients relating the p.vals to the q.vals p = R %*% q}
#'         \item{c0}{A vector of coefficients relating the q.vals to the objective function theta = c0 %*% q}
#'         \item{iqR}{A matrix with coefficients to represent the inequality constraints}
#'     }
#' 
#' @export
#' @examples 
