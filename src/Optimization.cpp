...
BOOL COptimization_ :: ParseFile (FILE * p_pFile)
{
	...
	while (szString = (char *) VarStrList. Dequeue ())
	{
		...
		{
			printf ("ERROR: Unable to successfully parse variable name.\n");
			printf ("\t%s\n", szString);
			bStatus = FALSE;
			goto ClearParseData;
		}
	...
	while (szString = (char *) ParamStrList. Dequeue ())
	{
		if (! ParseSymbol (szString, Symbol))
		{
			printf ("ERROR: Unable to successfully parse parameter name.\n");
			printf ("\t%s\n", szString);
			bStatus = FALSE;
			goto ClearParseData;
		}
	...
	while (szString = (char *) ConstStrList. Dequeue ())
	{
		...
		{
			printf ("ERROR: Unable to successfully parse constraint.\n");
			printf ("\t%s\n", szString);
			bStatus = FALSE;
			goto ClearParseData;
		}
	...
	if (szObjective)
	{
		...
		{
			printf ("ERROR: Unable to successfully parse objective function.\n");
			printf ("\t%s\n", szObjective);
			bStatus = FALSE;
			goto ClearParseData;
		}
	...
	{
		printf ("ERROR: No Objective function was supplied.\n");
		bStatus = FALSE;
		goto ClearParseData;
	}
